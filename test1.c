...
//Junction Coordinates variables:
int juncNo =0; 
char Actions[1000];
...
float encoder_sensor_value = 1000;
...
void line_follow_task(void *arg)
{
  ...
  while(1)
  {
    ...
    if(sensor_value[0] < 400  && sensor_value[1] > 900  && sensor_value[2] > 900  && sensor_value[3] > 900 && encoder_sensor_value > 1) 
    {
        // case 1. left turn
        ...
        else if(front_sensor_value > 600)
        {
    ...
    else if (sensor_value[0] > 900 && sensor_value[1] > 900 && sensor_value[2] > 900  && sensor_value[3] < 400 && encoder_sensor_value <2) 
    {
        // case 2. right turn
        //    sub case. when there's a straight turn.
        turn = 'R';
    ...
    else if (sensor_value[0] > 900 && sensor_value[1] > 900 && sensor_value[2] > 900 && sensor_value[3] > 900 && encoder_sensor_value < 2) 
    {
        // case 3. T turn
        ...
        else if(front_sensor_value > 600)
        {
            ...
            else if(sensor_value[0] > 900 && sensor_value[1] > 900 && sensor_value[2] > 900 && sensor_value[3] > 900 && encoder_sensor_value > 1)
            {
            printf("BOT HAS ENTER ALLL WHITE AREA!!! \n");
            bot_stop(MCPWM_UNIT_0, MCPWM_TIMER_0);
